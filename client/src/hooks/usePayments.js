...
//     const [loadingInvoicePayments, setLoadingInvoicePayments] =
//         useState(false);
...
//     const createManualPayment = useCallback(async (paymentData) => {
//         try {
//             setCreatingPayment(true);
//             setError(null);

//             const response =
//                 await createManualPaymentService(paymentData);
...
//             const response =
//                 await getPaymentByIdService(paymentId);
...
//     const fetchInvoicePayments = useCallback(async (invoiceId) => {
//         try {
//             setLoadingInvoicePayments(true);
//             setError(null);

//             const response =
//                 await getInvoicePaymentsService(invoiceId);
